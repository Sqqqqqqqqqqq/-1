...
change:
	...
	mov	DWORD PTR -4[rbp], eax  #int tmp
...
.L3:
	...
	je	.L4
	sub	rsp, 4096
	or	QWORD PTR 4088[rsp], 0 #int a[n]
	jmp	.L3
.L4:
	mov	rdx, rax
	and	edx, 4095
...
.L6:
	...
	je	.L7
	sub	rsp, 4096
	or	QWORD PTR 4088[rsp], 0 #int b[n]
	jmp	.L6
.L7:
	mov	rdx, rax
	and	edx, 4095
...
.L11:
	mov	eax, DWORD PTR -108[rbp]
	cmp	DWORD PTR -100[rbp], eax #cmp i, n
	jl	.L16
	mov	edi, 10
	call	putchar@PLT
	mov	eax, 0
